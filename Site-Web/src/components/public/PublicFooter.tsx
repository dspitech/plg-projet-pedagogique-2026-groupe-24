...
export function PublicFooter() {
  return (
    <footer className="relative mt-20 border-t border-border/60 bg-gradient-to-b from-background to-card">
      <div className="container mx-auto px-4 lg:px-6 py-12 grid gap-10 md:grid-cols-4">
        <div className="space-y-3">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            valorisation de scripts Cloud & DevOps.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex items-center gap-2"><Mail className="h-4 w-4 text-primary" /> contact@cloudscripts.io</li>
            <li className="flex items-center gap-2"><Shield className="h-4 w-4 text-primary" /> Données sécurisées</li>
          </ul>
